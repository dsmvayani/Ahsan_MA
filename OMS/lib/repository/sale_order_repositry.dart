...
class SaleOrderRepository{
  ...
  Future<Response?> saveOrder(SaleOrderState obj) async {
    try{
      ...
      dio.options.headers['Authorization'] = 'Bearer ' + await SharedPreferencesConfig.getToken();
      dio.options.headers['Content-Type'] = 'application/json';
      var json = { "nIsEdit": obj.isEdit, "nBillDate" : obj.billDate, "nCustomerCode": user!.nCustomerCode, "nDescription": obj.description, "nProductList": obj.listProducts!.map((e) => e.toJson()).toList(), "nTotalQuantity": obj.totalQuantity, "nTotalItems": obj.totalItems, "nNetAmount" : obj.netAmount};
      Response response = await dio.post(api+"api/BSProOMS/SaveSaleOrder", data: json);
      return response;
    }
    catch (error){
      return null;
  ...
  Future<Response?> getProductLookup() async {
    try{
      ...
      dio.options.headers['Authorization'] = 'Bearer ' + await SharedPreferencesConfig.getToken();
      dio.options.headers['Content-Type'] = 'application/json';
      Response response = await dio.get(api+"api/BSProOMS/GetProductLookup");
      return response;
    }
    catch (error){
      return null;
  ...
  Future<Response?> getSaleOrderList(String isCompleted) async {
    try{
      ...
      dio.options.headers['Authorization'] = 'Bearer ' + await SharedPreferencesConfig.getToken();
      dio.options.headers['Content-Type'] = 'application/json';
      Response response = await dio.get(api+"api/BSProOMS/GetSaleOrderList?nCustomerCode="+user!.nCustomerCode+"&isCompleted="+isCompleted);
      return response;
    }
    catch (error){
      return null;
